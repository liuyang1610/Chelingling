...
import com.beijing.chelingling.adapter.RvGridAdapter.OnItemClickListener;
...
public class MyAddLoveCar
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        public boolean handleMessage(Message paramAnonymousMessage) {
            Toast.makeText(MyAddLoveCar.this, "添加成功", Toast.LENGTH_SHORT).show();
            MyAddLoveCar.this.finish();
            return false;
        }
    });
    private String id = "";
            ...
            public void onSuccess(String paramAnonymousString, Call paramAnonymousCall, Response paramAnonymousResponse) {
                ...
                try {
                    if (new JSONObject(paramAnonymousString).getString("code").equals("000")) {
                        MyAddLoveCar.this.handler.sendEmptyMessage(1);
                    }
                    return;
    ...
    public void onViewClicked(final View paramView) {
        switch (paramView.getId()) {
            ...
            case R.id.sunshudi:
                ...
                View localObject = View.inflate(this, R.layout.custom_dialog, null);
                ...
                this.mRvGridAdapter = new RvGridAdapter(this, this.strslist, this.sss);
                ...
                this.mRvGridAdapter.setOnItemClickListener(new RvGridAdapter.OnItemClickListener() {
                    public void onItemClick(View paramAnonymousView, int paramAnonymousInt) {
                        diqusuozai.setText(MyAddLoveCar.this.strslist[paramAnonymousInt]);
            ...
            case R.id.goucheriqi:
                ...
                TimePickerBuilder timePickerBuilder = new TimePickerBuilder(this, new OnTimeSelectListener() {
                    public void onTimeSelect(Date paramAnonymousDate, View paramAnonymousView) {
                        ...
                        MyAddLoveCar.this.goucheriqiss.setText(s);
                    }
                ...
                return;
            case R.id.wancheng:
                if ((this.aichepinpai.getText().toString().length() > 0) && (this.carcard.getText().toString().length() > 0) && (this.goucheriqiss.getText().toString().length() > 0) && (this.fadongjiaho.getText().toString().length() > 0) && (this.chejiahao.getText().toString().length() > 0)) {
                    postByOkGo(ChangWeb.MYADDLOVECAR);
                    return;
                }
                Toast.makeText(this, "请填写所有资料", Toast.LENGTH_SHORT).show();
                break;
        }
...
/* Location:              G:\chelingling\dex2jar-2.0\classes-dex2jar.jar!\com\beijing\chelingling\MyAddLoveCar.class
